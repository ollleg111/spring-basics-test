...
public class Constants {
    ...
    public static final String GET_FORMAT_FROM_FILE = "SELECT FORMAT FROM FILES WHERE ID = ?";
    ...
    public static final String SELECT_ALL_ID_FILES_FROM_STORAGE = "SELECT FILES.ID FROM FILES WHERE STORAGE = ?";
    public static final String GET_FORMAT_FROM_STORAGE = "SELECT FORMAT_SUPPORTED FROM STORAGE WHERE STORAGE.ID =";
